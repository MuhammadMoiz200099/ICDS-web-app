...
export const papersData: Array<ICallForPaper> = [
    {
        ...
        breif: "JICDS'21 invites authors to submit full papers describing completed or on-going research or development in the field of Data Science. Relevant topics for the conference include, but are not limited to, the following areas:",
        points: [
            'Data Preprocessing',
    ...
    },
    {
        ...
        para: [
            "JICDS'21 " + 'invites proposals for exhibition of products and/or libraries related to Data Science. The proposed demo can be an academic work as well as industrial solution.',
    ...
    },
    {
        ...
        para: [
            "JICDS'21 " + 'invites PhD scholar to present their doctoral thesis work related to Data Science. It is an opportunity for the students to interact with their colleagues as well as senior researchers and academia.',
