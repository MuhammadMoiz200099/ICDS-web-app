...
export const papersData: Array<ICallForPaper> = [
    {
        ...
        breif: "MAJICC'21 invites authors to submit full papers describing completed or on-going research or development in the field of Data Science. Relevant topics for the conference include, but are not limited to, the following areas:",
        points: [
            'Data Preprocessing',
    ...
    },
    {
        ...
        para: [
            "MAJICC'21 " + 'invites proposals for exhibition of products and/or libraries related to Data Science. The proposed demo can be an academic work as well as industrial solution.',
