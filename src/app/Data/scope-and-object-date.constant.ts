...
export const MockDataScopeObjective: Array<IScopeAndObjective> = [
    {
        ...
        paragraph: [
            "Muhammad Ali Jinnah university International Conference on Computing 2021 (MAJICC'21) is the second International Conference, a joint effort by the Department of Computer Science and The Muhammad Ali Jinnah University (MAJU). The goal of MAJICC'21 is to bring together renowned scientists and leading researchers from academia and industry at one platform with the focus of exchanging ideas on modern computing innovations, Data Preprocessing, data mining, data management, data security and advancement in the field of the Data Science.",
            "The research papers presenting innovative practices, result oriented frameworks, systems, tools and techniques and good general survey papers demonstrating future directions are also encouraged. Research papers depicting novel work are invited in any of the conference areas listed. Research paper will be reviewed based on the originality, quality and relevance to the scope of MAJICC'21. Accepted research papers will be published into the proceeding after one of the author’s paper presentation."
        ]
    },
    {
        heading: 'Scope',
        paragraph: ['With the mission to provide the premier forum for advancement, education, and adoption of the "science" of knowledge discovery and data mining from all types of data stored in computers and networks of computers in Pakistan and following the footsteps of many educational institutions around the world, MAJU is proud to announce the first-ever “MAJU International Conference on Data Science”, where renowned experts will share the stage provided by MAJU to illuminate the minds of up-and-coming Data Science enthusiasts with their knowledge of the field, in an effort to jump start the Data industry in Pakistan']
    },
    {
